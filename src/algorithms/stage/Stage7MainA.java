...
public class Stage7MainA extends Brain {
  ...
  private void process(String message){
    ...
    if (Integer.parseInt(instruction)==FIRE) {
      fireOrder=true;
      countDown=0;
      String xCoords = message.split(":")[3];
      String yCoords = message.split(":")[4];
      targetX=Double.parseDouble(xCoords);
      targetY=Double.parseDouble(yCoords);
        return;
    }
